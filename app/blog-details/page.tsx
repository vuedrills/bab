            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  ERPNext makes asset management painless — from purchase to perishment, IT infrastructure to equipment.
                  </p>
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  Our CRM tool makes your lead closure soar. 
                    {/* <span className="text-primary underline dark:text-white">
                    On-The-Fly Customizations
                    </span> */}
                     Customize form behavior by auto-fetching values, hide fields based on user roles, and create custom print formats
                  </p>
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                    Digital marketplace for Ui/Ux designers.
                  </h3>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  Don't miss out on the big picture of your sales team. ERPNext includes out-of-the-box reports to monitor team performance and analyze the lead traffic or sales stage of all prospects. You can even collaborate to address leads or opportunities with multiple assignments or mentions
                  </p>
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    ...
                    Organize, schedule, plan and analyze projects with a task-driven approach that will streamline team collaboration and accelerate your work.
                    </p>
