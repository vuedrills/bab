          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                Customisable Health Information System 
                </h2>
                ...
                <div>
                 ...
                 HIS provides a way to digitise operations of multi-speciality hospitals, diagnostic centres and other healthcare facilities 
                  </p>
                  ...
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                      src="/images/blog/patient-progress3b762d.png"
                        alt="image"
                        fill
                  ...
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                      src="/images/blog/appointment-calendardfd3a4.png"
                        alt="image"
                        fill
                        className="object-cover object-center"
                      />
