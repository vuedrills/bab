...
const AboutSectionOne = () => {
  ...
  return (
    <section id="about" className="pt-[130px] md:pt-20 lg:pt-28">
      <div className="container">
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Sales Management" />
                    <List text="Point of Sales (PoS)" />
                    <List text="Customer Relationship Management" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Warehouse Management System" />
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div
                className="wow fadeInUp relative mx-auto aspect-[25/24] max-w-[1200px] lg:mr-0"
                data-wow-delay=".2s"
              >
                <Image
